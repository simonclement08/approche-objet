...
public class TestListeString {
	...
	public static void main(String[] args) {
		...
		villes2.add(new Ville("Nice", 343000, Continent.EUROPE));
		villes2.add(new Ville("Carcasonne", 47800, Continent.EUROPE));
		villes2.add(new Ville("Narbonne", 53400, Continent.EUROPE));
		villes2.add(new Ville("Lyon", 484000, Continent.EUROPE));
		villes2.add(new Ville("Foix", 9700, Continent.EUROPE));
		villes2.add(new Ville("Pau", 77200, Continent.EUROPE));
		villes2.add(new Ville("Marseille", 850700, Continent.EUROPE));
		villes2.add(new Ville("Tarbes", 40600, Continent.EUROPE));
